  ...
  render() {
    return (
      <div>
        ...
        <span id="tooltip-btn" style={!this.state.isLoggedIn ? { cursor: "not-allowed" } : {}}>
        ...
        <Modal isOpen={this.state.modal} toggle={this.toggle} className={this.props.className}>
          ...
          <ModalBody>
            ...
            <Modal isOpen={this.state.nestedModal} toggle={this.toggleNested} onClosed={this.state.closeAll ? this.toggle : undefined}>
              ...
              <ModalBody>{this.state.hasapplied ? "You have already applied for this job" : `You have successfully applied for position ${this.props.details.title}`}</ModalBody>
              <ModalFooter>
